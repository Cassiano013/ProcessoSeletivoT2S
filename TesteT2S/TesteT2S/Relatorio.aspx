<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Relatorio.aspx.cs" Inherits="TesteT2S.Relatorio" %>
...
<body id="grad">
    <form id="form1" runat="server">
        ...
        <div id="container" class="col-offset-1 col-8 col-offset-1">
            ...
            <br /><asp:Label ID="Label2" runat="server"><h2><b>Relatório</b></h2></asp:Label><br />
            <div>
